...
Notes:
  ...
  --layer-name is required with --format maplibre and must contain only ASCII letters, digits, hyphens, or underscores.
  MapLibre output uses an output directory; existing outputs require --overwrite.
